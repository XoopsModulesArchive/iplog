...
// ------------------------------------------------------------------------- //
	...
	$log_handler = xoops_getmodulehandler('log', 'iplog');
 	...
 	if (count($log_handler->getNumberByRegion())>0) {
 	...
 	if (count($log_handler->getNumberByContinent())>0) {
 	...
 	if (count($log_handler->getTotalSecondsByCountry())>0) {
 	...
 	if (count($log_handler->getTotalSecondsByRegion())>0) {
 	...
 	if (count($log_handler->getTotalSecondsByContinent())>0) {
 	...
 	if (count($log_handler->getAdverageSecondsByCountry())>0) {
    ...
    if (count($log_handler->getAdverageSecondsByRegion())>0) {
    ...
    if (count($log_handler->getAdverageSecondsByContinent())>0) {
